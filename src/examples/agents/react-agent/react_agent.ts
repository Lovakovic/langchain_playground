...
const CatPictureSchema = z.object({
  filename: z
    .string()
    .optional()
    .describe('Optional filename for the cat picture (without extension)'),
});
...
async function main() {
  ...
  console.log(
    "🤖 Assistant: Hello! I'm your cat picture assistant. I can fetch random cat pictures from the internet and save them to your Desktop. Just ask me for a cat picture!",
  );
