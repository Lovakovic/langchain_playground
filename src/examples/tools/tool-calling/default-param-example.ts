  ...
  },
  {
    ...
    schema: z.object({
      ...
      metadata: z
        ...
        .describe('DO NOT provide this parameter - let it use the default value'),
    }),
  },
);
...
const main = async () => {
  ...
  const userInput =
    "Create a document with title 'Test Document' and content 'This is a test'. IMPORTANT: Do NOT provide the metadata parameter - let it use its default value.";
