    ...
    try {
      ...
      if (document.pages && document.pages.length > 0) {
        ...
        document.pages.forEach((page, pageIndex) => {
          ...
          console.log(
            `📐 Dimensions: ${page.dimension?.width}x${page.dimension?.height} ${page.dimension?.unit || 'unknown'}`,
          );
          ...
          if (page.blocks && page.blocks.length > 0) {
            ...
            page.blocks.slice(0, 3).forEach((block, blockIndex) => {
              ...
              console.log(
                `  Block ${blockIndex + 1}: "${text.substring(0, 50).replace(/\n/g, ' ')}${text.length > 50 ? '...' : ''}"`,
              );
          ...
          if (page.paragraphs && page.paragraphs.length > 0) {
            ...
            page.paragraphs.slice(0, 3).forEach((paragraph, pIndex) => {
              ...
              console.log(
                `  Paragraph ${pIndex + 1}: "${text.substring(0, 50).replace(/\n/g, ' ')}${text.length > 50 ? '...' : ''}"`,
              );
          ...
          if (page.lines && page.lines.length > 0) {
            ...
            page.lines.slice(0, 3).forEach((line, lIndex) => {
              ...
              console.log(
                `  Line ${lIndex + 1}: "${text.substring(0, 30).replace(/\n/g, ' ')}${text.length > 30 ? '...' : ''}"`,
              );
